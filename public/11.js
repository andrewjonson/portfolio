...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: _objectSpread(_objectSpread({}, Object(vuex__WEBPACK_IMPORTED_MODULE_0__["mapActions"])(['resetPassword'])), {}, {
    onSubmit: function onSubmit() {
      var _this = this;

      this.resetPassword(this.user).then(function (r) {
        _this.overlay = true;
                ...
                _c(
                  ...
                  [
                    ...
                    _c("div", { staticClass: "form-group row mb-0" }, [
                      _c("div", { staticClass: "col-md-9 offset-md-2" }, [
                        _c(
                          "button",
                          {
